...
export class AdminCommissionController {
  ...
  @ApiOperation({
    summary:
      'Pull the active global system commission setup for public components access',
  })
  @ApiResponse({
    status: 200,
    description:
      'Global commission rules properties schema returned successfully.',
  })
  ...
  @ApiOperation({
    summary: 'Create global system commission rule configuration',
  })
  ...
  @ApiOperation({
    summary:
      'Pull the current global system configuration metrics parameters (Admin Only)',
  })
  @ApiResponse({
    status: 200,
    description: 'Global parameters entry record returned.',
  })
  async getCommission() {
    return this.commissionService.getCommission();
  }
  ...
  @ApiOperation({
    summary:
      'Update the global system commission rule properties metrics (Admin Only)',
  })
  @ApiResponse({
    status: 200,
    description:
      'Global platform configuration variables entry overwritten successfully.',
  })
